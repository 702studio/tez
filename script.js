document.addEventListener('DOMContentLoaded', () => {
    ...
    const animationSequence = [
        { text: '7', duration: 300, delay: 50 },
        { text: '0', duration: 200, delay: 50 },
        { text: '2', duration: 200, delay: 50 },
        { text: '702', duration: 350, delay: 50 },
        { text: '702.studio', duration: 500, delay: 100, hasBlinkingDot: true },
        { text: 'Coming Soon', duration: 800, delay: 200 }
    ];
    ...
    function runNextAnimation() {
        ...
        anime.timeline({
            ...
            complete: () => {
                ...
                }, currentItem.delay + 150); // Significantly reduced pause
            }
        })
        .add({
            targets: textWrapper.childNodes,
            ...
            delay: anime.stagger(30, {from: 'center'}), // Faster character stagger
        });
